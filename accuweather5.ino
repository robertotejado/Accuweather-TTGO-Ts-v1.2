...
const String endpoint = "http://dataservice.accuweather.com/forecasts/v1/daily/5day/XXXXXXXXXXXX.json?apikey=XXXXXXXXXXXXXXXXXXXXXXXXX&language=es&metric=true"; 
...
const String diasemana = getDayOfWeekIndex(day(Headline_EffectiveEpochDate), month(Headline_EffectiveEpochDate),  year(Headline_EffectiveEpochDate));
const String epoch_headline= diasemana;
client.println(" ");
client.println(epoch_headline );  client.print("-");
client.println(bufferfecha);  client.print("-");
client.println( Headline_Text );
...
if (counting>=4){ counting=0;} //reset
